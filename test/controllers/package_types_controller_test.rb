...
class PackageTypesControllerTest < ActionController::TestCase
  ...
  test "should create package_type" do
    assert_difference('PackageType.count') do
      post :create, package_type: { data_source_data_source_id: @package_type.data_source_data_source_id, package_type_id: @package_type.package_type_id, package_type_name: @package_type.package_type_name, status: @package_type.status }
    end
  ...
  test "should update package_type" do
    patch :update, id: @package_type, package_type: { data_source_data_source_id: @package_type.data_source_data_source_id, package_type_id: @package_type.package_type_id, package_type_name: @package_type.package_type_name, status: @package_type.status }
    assert_redirected_to package_type_path(assigns(:package_type))
  end
