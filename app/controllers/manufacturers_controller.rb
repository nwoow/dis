class ManufacturersController < ApplicationController
  ...
  private
    ...
    def manufacturer_params
      params.require(:manufacturer).permit(:manufacturer_name, :manufacturer_abbr, :address1, :address2, :state_id, :city_id, :pin, :phone, :fax, :email, :website, :mobilephone, :data_source_id, :status)
    end
end
