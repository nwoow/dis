class GenericsController < ApplicationController
  ...
  private
    ...
    def generic_params
      params.require(:generic).permit(:generic_name, :is_essential, :generic_type_id, :schedule_id, :preg_category_id, :food_intake_id, :rxcui, :data_source_id, :status, :is_combination)
    end
end
